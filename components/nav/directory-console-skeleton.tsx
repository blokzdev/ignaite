  ...
  return (
    <div aria-hidden className="container-site px-6">
      <div className="flex items-center gap-2 pt-2.5 pb-2.5">
        <div className="h-8 flex-1 rounded-full bg-white/[0.04] ring-1 ring-white/[0.08] ring-inset" />
        <div className="hidden h-8 w-24 rounded-full bg-white/[0.04] ring-1 ring-white/[0.08] ring-inset sm:block" />
        <div className="h-8 w-24 rounded-full bg-white/[0.04] ring-1 ring-white/[0.08] ring-inset" />
      </div>
      <div className="flex items-center gap-1.5 overflow-hidden pb-2.5">
        {[64, 52, 80, 48, 72, 56, 68].map((w, i) => (
          <div
            key={i}
            style={{ width: w }}
            className="h-8 shrink-0 rounded-full bg-white/[0.04] ring-1 ring-white/[0.08] ring-inset"
          />
        ))}
      </div>
    </div>
