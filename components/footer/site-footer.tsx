...
// Brand glyphs (solid, fill=currentColor) — lucide-react dropped its brand
// logos, and outline icons would clash with these marks. Paths from Simple
// Icons (CC0). Email uses a neutral envelope to match the solid set.
...
const socials: ReadonlyArray<{
  ...
  { href: brand.social.github, label: "GitHub", Icon: GitHubIcon },
  { href: brand.social.linkedin, label: "LinkedIn", Icon: LinkedInIcon },
  { href: brand.social.twitter, label: "X", Icon: XIcon },
  { href: brand.social.telegram, label: "Telegram", Icon: TelegramIcon },
  { href: `mailto:${brand.social.email}`, label: "Email", Icon: MailIcon },
];
